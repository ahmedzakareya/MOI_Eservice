...
{
    public class NavbarAreaViewComponent: ViewComponent
    {
        private readonly HelperUrlApi _helperUrlApi;
        private readonly HttpClient _httpClient;
        private readonly string _baseUrl;

        public NavbarAreaViewComponent(IConfiguration configuration, HelperUrlApi helperUrlApi, HttpClient httpClient)
        {
